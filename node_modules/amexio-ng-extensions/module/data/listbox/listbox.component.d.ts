...
export declare class AmexioListBoxComponent extends LifeCycleBaseComponent implements AfterViewInit, OnInit, OnDestroy {
    ...
    ngOnInit(): void;
    listenListboxOutClick(): void;
    onArrowdown(): void;
    onArrowUp(): void;
    onEnterPress(): void;
    updateComponent(): void;
    setData(httpResponse: any): void;
    onSelectClick(viewRows: any): void;
